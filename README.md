[![Build Status](https://github.com/opspec-pkgs/base64url.decode/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/base64url.decode/actions?query=workflow%3Abuild+branch%3Amain)
